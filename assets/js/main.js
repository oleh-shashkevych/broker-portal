...
// Проверяем существование всех обязательных элементов
if (!searchInput || !searchContainer || !cancelButtonInput || !dropdownMenu) {
...
const mockData = [
	...
	{ business_name: 'Amazon', program_type: 'E-commerce', url: 'https://amazon.com' },
	{ business_name: 'Adobe', program_type: 'Software', url: 'https://adobe.com' },
	{ business_name: 'Netflix', program_type: 'Streaming', url: 'https://netflix.com' },
	{ business_name: 'Nike', program_type: 'Sportswear', url: 'https://nike.com' },
];
...
document.addEventListener('click', function (e) {
	if (!searchContainer || !dropdownMenu) return;
...
// Работа с кнопками раскрытия контента
	...
	collapseButtons.forEach(button => {
		button.addEventListener('click', function (e) {
			...
			if (content) {
				...
				console.warn('No content found for collapse button');
			}
		});
	});
} else {
	console.warn('No collapse buttons found in the DOM.');
}